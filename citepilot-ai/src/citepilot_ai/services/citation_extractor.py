...
4. STYLE MANUAL COMPLIANCE:
   ...
   - Audit reference list alphabetical sorting.
   - Audit missing page numbers (p. / pp.) for direct quote citations.
   Flag style issues as Category: "style_warning", Severity: "warning".
