...
export default function Hero({ onLaunchApp }: HeroProps) {
  return (
    <section className="py-[76px] pb-16">
      <div className="max-w-[1080px] mx-auto px-8 grid grid-cols-[1fr_1fr] gap-13 items-center">
        <div>
          <span className="inline-block font-type text-[13px] font-bold tracking-wider text-ink-soft mb-5.5 before:content-['[\\0020'] after:content-['\\0020]'] before:text-ink-faint after:text-ink-faint">
            AI CITATION AUDIT
          </span>
          <h1 className="font-type font-bold text-[clamp(30px,4.2vw,46px)] leading-[1.15] m-0">
            Verify every citation. Before your reader does.
          </h1>
          <p className="mt-5.5 text-[16.5px] leading-[1.65] text-ink-soft max-w-[48ch]">
          ...
          <div className="flex gap-3.5 mt-7.5 flex-wrap">
            <button
          ...
          <p className="mt-5 font-type text-[13px] font-semibold text-ink-faint">
        ...
        <div>
          <div className="bg-paper-card border-2 border-rule scroll-shadow relative p-[26px_28px_30px]">
            ...
            <div className="font-type text-[13.5px] leading-[2] text-[#2A251C]">
              <p>
                ...
                <span className="font-hand text-xl font-bold leading-[1.15] absolute whitespace-nowrap text-red top-14 -right-1.5 -rotate-3">
                  fabricated? not
                  <br />
                  in Crossref
                </span>
                ...
                <span className="font-hand text-xl font-bold leading-[1.15] absolute whitespace-nowrap text-ochre top-[118px] right-2 rotate-2">
                  check page
                  <br />
                  range
                </span>{" "}
          ...
          <div className="flex gap-5 flex-wrap mt-5 font-type text-xs font-bold text-ink-soft">
