export default function WhyItMatters() {
  return (
    <section className="py-20 border-t-2 border-rule" id="problem">
      <div className="max-w-[1080px] mx-auto px-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-paper-card border-2 border-rule p-6 pr-5.5 relative shadow-[3px_3px_0_rgba(34,29,22,0.06)]">
            <div className="w-[76px] h-[76px] rounded-full border-3 border-red text-red flex items-center justify-center text-center font-bold text-[9.5px] tracking-wider uppercase leading-[1.3] p-1.5 absolute -top-4 -right-3.5 -rotate-10">
              fabricated
            </div>
          ...
          <div className="bg-paper-card border-2 border-rule p-6 pr-5.5 relative shadow-[3px_3px_0_rgba(34,29,22,0.06)]">
            <div className="w-[76px] h-[76px] rounded-full border-3 border-ochre text-ochre flex items-center justify-center text-center font-bold text-[9.5px] tracking-wider uppercase leading-[1.3] p-1.5 absolute -top-4 -right-3.5 rotate-7">
              mismatched
            </div>
            <h3 className="font-type text-[17px] font-bold mt-1.5 mb-2.5 max-w-[85%]">
          ...
          <div className="bg-paper-card border-2 border-rule p-6 pr-5.5 relative shadow-[3px_3px_0_rgba(34,29,22,0.06)]">
            <div className="w-[76px] h-[76px] rounded-full border-3 border-green text-green flex items-center justify-center text-center font-bold text-[9.5px] tracking-wider uppercase leading-[1.3] p-1.5 absolute -top-4 -right-3.5 -rotate-6">
              retracted
            </div>
            <h3 className="font-type text-[17px] font-bold mt-1.5 mb-2.5 max-w-[85%]">
