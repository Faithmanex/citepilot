...
export default function Sidebar({
  ...
  return (
    <aside
      className="bg-sidebar text-sidebar-text p-5 pr-3.5 sticky top-0 h-screen overflow-y-auto"
      role="navigation"
      aria-label="Audit Drawer Navigation"
    >
      <div className="flex items-center gap-[9px] px-2.5 pb-[22px] pt-1.5 font-extrabold text-[17px] text-white">
        <span
